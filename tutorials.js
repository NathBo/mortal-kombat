var tutobasics = [
    {
        char : ["raiden","raiden"], ai : -1, pv : [20,15], moves : [["lpunch","hpunch"],["lpunch"]], aimoves : [],
        jumper : 0, regenerate : false,
        msg : "Pressing punch (by default B) will do a punch"
    },
    {
        char : ["raiden","raiden"], ai : -1, pv : [20,15], moves : [["lkick","mkick","hkick"],["lkick"]], aimoves : [],
        jumper : 0, regenerate : false,
        msg : "Similarly, pressing kick (by default N) will perform a kick"
    },
    {
        char : ["raiden","raiden"], ai : -1, pv : [20,15], moves : [["hpunch","mkick","hkick"],["lpunch"]], aimoves : [],
        jumper : 0, regenerate : false,
        msg : "If you do a kick or punch + left or right, you can perform more powerful versions of the base moves"
    },
    {
        char : ["raiden","raiden"], ai : -1, pv : [20,25], moves : [["hkick"],["lpunch"]], aimoves : [],
        jumper : 0, regenerate : false,
        msg : "Roundhouses in particular are performed by pressing forward and kick, they are very powerful!"
    },
    {
        char : ["raiden","raiden"], ai : 2, pv : [30,20], moves : [["hkick","grab"],["block"]], aimoves : [],
        jumper : 0, regenerate : false,
        msg : "However, your opponent can block your move by pressing back. In this case try grabbing them by pressing the grab button (default H) with no direction"
    },
    {
        char : ["raiden","raiden"], ai : 0, pv : [100,60], moves : [["lpunch", "lkick", "hpunch", "mkick","hkick","grab", "block"],["lpunch", "lkick", "hpunch", "mkick","hkick","grab", "block"]], aimoves : [],
        jumper : 0, regenerate : false,
        msg : "You now know the very basics of kombat, here is your final challenge!"
    },
]

var tutocrouch = [
    {
        char : ["mileena","mileena"], ai : -1, pv : [20,15], moves : [["clpunch","clkick", "cmkick", "huppercut", "crouch"],["clpunch"]], aimoves : [],
        jumper : 0, regenerate : false,
        msg : "Pressing down and punch or kick will perform crouching moves!"
    },
    {
        char : ["mileena","mileena"], ai : 0, pv : [20,15], moves : [["clpunch","clkick", "cmkick", "huppercut", "crouch"],["lpunch","mkick"]], aimoves : [],
        jumper : 1, regenerate : false,
        msg : "By crouching, you will not get hit by most high moves, use this to beat your ennemy."
    },
    {
    ...
    },
    {
        ...
        msg : "Huppercuts are an amazing anti air, try to use them to beat your opponent!"
    },
    {
        char : ["mileena","mileena"], ai : 0, pv : [80,70], moves : [["huppercut", "crouch", "block", "clpunch", "clkick", "cmkick"],["crouch", "block", "clpunch", "hkick","lpunch"]], aimoves : [],
...
var tutojump = [
    {
        char : ["scorpion","scorpion"], ai : -1, pv : [20,20], moves : [["jkick", "jskick", "jpunch", "jump"],["clpunch"]], aimoves : [],
        jumper : 0, regenerate : false,
        msg : "You can jump by pressing the jump button (by default J or up), once in the air, press kick or punch to attack. Pressing the jump button very briefly or pressing jump and down at the same time will perform a short hop"
    },
    {
...
var tutospecial = [
    {
        ...
        jumper : 0, regenerate : false,
        msg : "Special moves are all done with the special button (by default M or , in AZERTY), use raiden's neutral special by pressing special and no direction"
    },
    {
    ...
    {
        char : ["raiden","raiden"], ai : 0, pv : [20,16], moves : [["boltthrow", "block"],["lpunch", "lkick", "mkick", "mpunch"]], aimoves : [],
        jumper : 0, regenerate : false,
        msg : "Now, try to use raiden's back special by pressing special and back"
    },
    {
        char : ["scorpion","raiden"], ai : 0, pv : [20,10], moves : [["leg_takedown", "crouch", "block"],["lpunch", "lkick", "mkick", "mpunch"]], aimoves : [],
        jumper : 0, regenerate : false,
    ...
    },
    {
        ...
        msg : "You can cancel normal moves into special moves. Try to cancel raiden's roundhouse into his forward special for a simple combo"
    },
    {
...
var tutocombo = [
    ...
    },
    {
        ...
        jumper : 0,  regenerate : true,
        msg : "Ok now cancel your light punch into your high punch into your roundhouse"
    },
    {
        char : ["raiden","raiden"], ai : 0, pv : [30,15], moves : [["lpunch", "hpunch", "block"],["jump", "lpunch", "jpunch"]], aimoves : [],
        jumper : 4,  regenerate : true,
        msg : "Now, try to do the light punch to high punch combo against a real opponent"
    },
    {
        char : ["raiden","raiden"], ai : -1, pv : [20,22], moves : [["clpunch", "crouch", "huppercut"],["clpunch"]], aimoves : [],
        jumper : 0,  regenerate : true,
        msg : "This way of comboing also works when you crouch, try to combo your crouching light punch into your huppercut for example"
    },
    {
        char : ["raiden","raiden"], ai : -1, pv : [20,27], moves : [["lpunch", "hkick", "jpunch", "jump"],["clpunch"]], aimoves : [],
        jumper : 0,  regenerate : true,
        msg : "You can also combo from a jump punch on a grounded opponent. Into a light punch then into a roundhouse for example"
    },
    {
