var lifebarpng=new Image();lifebarpng.src = 'ressource/ui/barlife.png';
	...
	var stagesstruct = [towerstructurepng, deadpoolpng, wastestructurepng];
	var stagesground = [towergroundpng, null, wastegroundpng];
	var stagesbackground = [towerbackgroundpng, null, wastebackgroundpng];
	var grounds = [240,220, 240];
	var stagesizes = [720,670, 720];
	var backgroundscroll = [0.2,0,0];
