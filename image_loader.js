var lifebarpng=new Image();lifebarpng.src = 'ressource/ui/barlife.png';
	...
	var stagesstruct = [towerstructurepng, deadpoolpng, wastestructurepng, forestgroundpng];
	var stagesground = [towergroundpng, null, wastegroundpng, null];
	var stagesbackground = [towerbackgroundpng, null, wastebackgroundpng, forestbackgroundpng];
	var grounds = [240, 220, 240, 240];
	var stagesizes = [720,670, 720,760];
	var backgroundscroll = [0.2,0,0,0.2];
